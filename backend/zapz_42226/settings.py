"""
Django settings for zapz_42226 project.
...
WSGI_APPLICATION = 'zapz_42226.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "zapz_42226 API",
    "DESCRIPTION": "API documentation for zapz_42226 App",
    "VERSION": "v1",
}
